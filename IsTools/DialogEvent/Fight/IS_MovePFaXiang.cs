...
{
    [DialogEvent("IS_MovePFaXiang")]
    public class IS_MovePFaXiang : IDialogEvent
    {
        public void Execute(DialogCommand command, DialogEnvironment env, Action callback)
        {
            ...
            FaXiangUtils.MoveGameObjectPosition(FaXiangUtils.GetAvatarSkl(target == 0 ? true : false), x, y, z);
